...
const resources = {
  en: {
    translation: {
      ...
      "course_map_desc": "Your step-by-step journey to master this file",
      "building_map": "Building Course Map...",
      "ai_analyzing": "AI is analyzing the file and breaking it down into interactive lessons.",
      "intro": "Introduction",
      ...
      "no_terms_found": "No definitions found for",
      "definition": "Definition",
      "see_also": "See Also",
      "study_mode_on": "Study Mode",
      "study_mode_off": "Normal Mode",
  ...
  ar: {
    translation: {
      ...
      "prepare_file": "إعداد الملف",
      "upload_instruction_modal": "قم برفع الملف أولاً، ثم سنقوم بضبط الإعدادات.",
      "confirm_upload": "تأكيد وبدء الرفع",
      "choose_file": "اختر ملفاً",
      "please_wait": "يرجى الانتظار...",
      "drag_drop_label": "اسحب الملف هنا أو اضغط للاختيار",
      "allowed_content": "PDF, DOCX, TXT حتى 32 ميجابايت",
      "file_name": "اسم الملف",
      "enter_file_name": "أدخل اسم الملف...",
      "study_language": "لغة الشرح والدراسة",
      "study_language_desc": "اختر اللغة التي تريد أن يشرح لك المعلم بها (وليس لغة الملف الأصلية).",
      "cancel_reupload": "إلغاء وإعادة الرفع",
      "save_start": "حفظ وبدء الدراسة",
      "saving": "جاري الحفظ...",
      "processing_step_1": "جاري فحص الملف...",
      "processing_step_2": "يتم استخراج الدروس...",
      "processing_step_3": "بناء الشرح والمفاهيم...",
      "processing_step_4": "نضع اللمسات الأخيرة...",
      "ai_processing_desc": "يقوم الذكاء الاصطناعي الآن بتجهيز مسارك التعليمي المخصص.",
      "error_no_id": "لم يتم استلام معرف الملف. يرجى المحاولة مرة أخرى.",
      "error_processing_start": "فشل في بدء المعالجة",
      ...
      "ai_analyzing": "يقوم الذكاء الاصطناعي الآن بتحليل الملف وتقسيمه إلى دروس تفاعلية.",
      "intro": "مقدمة",
      "explanation": "الشرح",
      "quiz": "اختبر فهمك",
      "important": "مهم",
      "preparing_content": "جاري تحضير المحتوى...",
      ...
      // Admin Tickets
      "admin_tickets_title": "تذاكر الدعم الفني",
      ...
      "ticket_subject_missing": "بدون عنوان",
      "unknown_user": "مستخدم غير معروف",
      "mark_as_closed": "إغلاق التذكرة",
      "mark_as_open": "إعادة فتح التذكرة",
      "close": "إغلاق",
      "reopen": "إعادة فتح",
      ...
      "no_terms_found": "ما لقينا تعريف لـ",
      "definition": "التعريف",
      "see_also": "شف بعد",
      "study_mode_on": "وضع الدراسة",
      "study_mode_off": "الوضع العادي",
      ...
      "ticket_subject": "الموضوع (اختياري)",
      "ticket_subject_placeholder": "مثال: مشكلة في رفع ملف PDF...",
      "ticket_message": "كيف نقدر نساعدك؟",
      ...
      "topic_drill": "تدريب مركز",
      "quick_concept": "المفهوم في دقيقة",
      "test_yourself": "اختبر نفسك",
      "finish_drill": "إنهاء التدريب",
      "correct_great_job": "إجابة صحيحة! أحسنت.",
      "review_concept_above": "راجع المفهوم أعلاه",
      "review_drill": "راجع التدريب",
      "generate_drill": "ابدأ التدريب",
      "generating_drill": "نجهز لك التدريب...",
      ...
      "error_generating_predictions": "فشلنا في توقع الأسئلة. حاول مرة ثانية.",
